function lpInitApi(interpreter, scope) {
  ...
  wrapper = function() { return interpreter.createPrimitive(getxyCT()[0]); };
  interpreter.setProperty(scope, 'getxCT', interpreter.createNativeFunction(wrapper));

  wrapper = function() { return interpreter.createPrimitive(getxyCT()[1]); };
  interpreter.setProperty(scope, 'getyCT', interpreter.createNativeFunction(wrapper));
